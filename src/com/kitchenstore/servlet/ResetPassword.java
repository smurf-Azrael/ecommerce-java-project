...
public class ResetPassword extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		// Value get for resend OTP
		String resend = request.getParameter("resend");

		// Value get for forget password which is requested from account setting
		String ForgetPass = request.getParameter("forgetpassword");
		if (email != null) {
			...
			if (registeredEmail) {
				...
				httpSession.setAttribute("forgetPasswordOTP", otp);
				httpSession.setAttribute("email", email);
				RequestDispatcher dispatcher = request.getRequestDispatcher("verify-forget-password.jsp");
				dispatcher.forward(request, response);
			} else {
				response.sendRedirect("forget-password.jsp?registered=false");
			}
		} else if (resend != null) {
			...
			httpSession.setAttribute("forgetPasswordOTP", otp);
			httpSession.setAttribute("email", email);
			httpSession.setAttribute("alredyLogin", "true");
			// Forward Request
			RequestDispatcher dispatcher = request.getRequestDispatcher("verify-forget-password.jsp");
			dispatcher.forward(request, response);
		}
