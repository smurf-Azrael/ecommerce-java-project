			...
			if (loginUser != null) {
				...
				if (orderDetails != null) {
					...
					if (outofStock) {
						...
						request.setAttribute("customerDetails", loginUser);
						request.setAttribute("totalAmount", orderDetails.getTotalPrice());
						RequestDispatcher requestDispatcher = request.getRequestDispatcher("pgRedirect.jsp");
