...
<body>
	...
	<%
		String registeredAccount = request.getParameter("registered");
	%>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-6">
					...
					<form action="ResetPass" id="registrationForm" method="POST">
						<div class="d-flex">
						...
						<div class="password_base bg-light p-3 mb-2 border border-secondary border-top-0">
							...
							<div class="row">
								<div class="col-md-6">
									...
									<span class="font-0-8rem pl-2">Min 8 - Max 15 characters
									</span>
								</div>
								<div class="col-md-6">
						...
						<div class="form-footer">
							<button type="submit" class="btn btn-primary rounded"
								id="formSubmit">Reset Password</button>
						</div>
						<!-- End .form-footer -->
					</form>
				</div>
