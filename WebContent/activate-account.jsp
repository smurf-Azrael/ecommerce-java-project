		...
		<div class="container mx-auto">
			<div class="row">
				<div class="col-md-6">
						...
						<div class="row">
							<div class="col-8">
								<div class="alert alert-success alert-dismissible fade show"
									...
									<strong> Verification code has been resent! You have got an email at <%=user.getEmail()%></strong>
									<% } else { %>
									<strong>Verification code has been sent at <%=user.getEmail()%></strong>
									<% } %>
					...
					<div class="otp-form">
						<form method="post" action="Registration" id="verifyForm" class="digit-group" data-group-name="digits"
					...
					<div class="row">	
						<div class="col-md-6 col-sm-6 col-xl-8">
							<div class="row border-bottom pb-4">
								<div class="col-6">
									<form action="ActivateAccount" method="post" id="resendForm" class="d-inline">
	...
	$(document).ready(function () {
		  ...
		  function timer(remaining) {
		    ...
		    if (timerOn) {
		      ...
		      $("#recendCode").attr("href", "ActivateAccount");
		    }
		  }
