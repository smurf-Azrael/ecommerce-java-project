...
<body>
	<% List<Category> categoryList=(List) request.getAttribute("categoryList");
		Category categoryBean= (Category) request.getAttribute("editCategory");
	   ...
	   {
		   cNameValue=categoryBean.getCategoryName();
	   }
	%>
	<!-- Header File -->
				...
				<div class="col-lg-10 order-lg-last dashboard-content">
											...
											<div class="col-6">
												<div class="form-group required-field">
													<label for="fame" class="font-weight-normal"
														style="font-size: 14px;">Category
														name</label> <input type="text" class="form-control rounded" id="categoryName"
														style="font-size: 16px;" placeholder="Enter here" name="cname" value="<%=cNameValue%>">
													<% // for hiddeen category id
													if(categoryBean!=null){ %>
													<input type="hidden" value="<%=Encryption.encode(Integer.toString(categoryBean.getCategoryId()))%>" name="cid"> 
													<% } %>
													<div class="text-danger my-3" id="categoryCheck">Please
					...
					<div class="row">
						<div class="col-12">
							<div class="alert alert-danger alert-dismissible fade show"
								role="alert">
								<strong>New Category not added! Please try again later</strong>
								<button type="button" class="close" data-dismiss="alert"
									aria-label="Close">
									<span aria-hidden="true">&times;</span>
								</button>
					...
					<div class="row">
						<div class="col-12">
							<div class="alert alert-danger alert-dismissible fade show"
								role="alert">
								<strong>Category not deleted! Please try again later</strong>
								<button type="button" class="close" data-dismiss="alert"
									aria-label="Close">
									<span aria-hidden="true">&times;</span>
								</button>
						...
						<table class="table table-hover" id="dataTable">
							...
							<tbody>
								...
								<tr class="text-dark bg-light text-center">
									...
									<td class="text-center"><a href="Category?edit=<%=Encryption.encode("true") %>&uid=<%=Encryption.encode(Integer.toString(category.getCategoryId())) %>"
										 class="text-success"
										style="font-size: 16px; cursor: pointer;"><i
											class="fas fa-edit"></i></a></td>
									<td class="text-center"><a onclick="getDelId(<%=Integer.toString(category.getCategoryId()) %>)"
				...
				<aside class="sidebar col-lg-2">
					<div class="widget widget-dashboard">
						...
						<ul class="list">
							...
							<li class="active"><a href="Category"><i
			...
			<div class="modal fade" id="exampleModal" tabindex="-1"
				...
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						...
						<div class="modal-body text-center"><h4 style="color:#454545;">Are you sure to delete Category ( including all Subcategory and Products under this category) ?</h4></div>
    ...
    <script>
    		function getDelId(id) {
				var strLink = "RemoveCategory?id=" + id;
    ...
    <script>
					...
					<% i = 1;
					for (Category category : categoryList) {%>
							tableRow=["<%=i++%>","<%=category.getCategoryName()%>"];
							rows.push(tableRow);
							tableRow="";
					<% }%>
					let csvContent = "data:text/csv;charset=utf-8,Sr No,Category Name\r\n";
					...
					let today=new Date();
					exportBtn.setAttribute("download", "category_" + today.getDate() + "-" + today.getMonth() + "-" + today.getFullYear() + ".csv");
					});
	</script>
