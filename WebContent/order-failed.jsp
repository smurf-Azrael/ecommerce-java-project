		...
		<div class="container mb-5 pb-5">
			...
			<div class="">
				...
				<div class="text-center">
					<h1><i class="fas fa-times-circle text-danger"></i> Order processing failed! </h1>
					<p class="h4">if you made payment for order please <a href="ContactUs"> contact us</a></p>
