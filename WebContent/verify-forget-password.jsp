...
<body>
	...
	String forgetPasswordOTP= (String) httpSession.getAttribute("forgetPasswordOTP");
		...
		<div class="container mx-auto">
			<div class="row">
				<div class="col-md-6">
					...
					<div class="otp-form">
						<form method="post" action="reset-password.jsp" id="verifyForm" class="digit-group" data-group-name="digits"
					...
					<div class="row">	
						<div class="col-md-6 col-sm-6 col-xl-8">
							<div class="row border-bottom pb-4">
								<div class="col-6">
									<form action="ResetPassword" method="post" id="resendForm" class="d-inline">
	...
	$(document).ready(function () {
		  ...
		  function timer(remaining) {
		    ...
		    if (timerOn) {
			      ...
			      $("#recendCode").attr("href", "ResetPassword");
			    }
		  }
